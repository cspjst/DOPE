...
const dope_float_t dope_read_number(dope_size_t i, dope_program_t* program, dope_vartab_t* vars, dope_vectab_t* vecs) {
...
void dope_write_number(dope_float_t number, dope_size_t i, dope_program_t* program, dope_vartab_t* vars, dope_vectab_t* vecs) {
    const char* name = dope_field_to_str(program, i);
    if(dope_is_valid_var_name(name)) {
